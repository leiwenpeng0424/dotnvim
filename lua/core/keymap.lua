...
local mappings = {
    ...
    ['<leader-h>|viw"0p'] = {
        mode = "n",
        opts = { noremap = true, nowait = false },
    },
    ...
    ["gc|<cmd>Lspsaga range_code_action<cr>"] = {
        mode = "n",
        opts = { noremap = true },
    },
    ...
    -- trouble.nvim
    ["<leader>t|<cmd>TroubleToggle<cr>"] = { mode = "n", opts = { noremap = true } },
    ...
    -- Comment.nvim
    ['<leader>/|<cmd>:lua require("Comment.api").toggle.blockwise.current()<cr>'] = {
        mode = "n",
        opts = { noremap = true },
    },
    ["<leader>/|<Plug>(comment_toggle_blockwise_visual)"] = {
        mode = "v",
        opts = { noremap = true },
    },
