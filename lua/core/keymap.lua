...
local mappings = {
    ...
    ['}|:resize +5<cr>']                    = { mode = 'n', opts = { noremap = true } },
    ['<c-b>|<cmd>NeoTreeShowToggle<cr>']         = { mode = 'n', opts = { noremap = true } },
    -- lspsaga
    ['gf|<cmd>Lspsaga lsp_finder<cr>']           = { mode = 'n', opts = { noremap = true } },
    ['gs|<cmd>Lspsaga signature_help<cr>']       = { mode = 'n', opts = { noremap = true } },
    ['g[|<cmd>Lspsaga diagnostic_jump_prev<cr>'] = { mode = 'n', opts = { noremap = true } },
    ['g]|<cmd>Lspsaga diagnostic_jump_next<cr>'] = { mode = 'n', opts = { noremap = true } },
    ['gr|<cmd>Lspsaga rename<cr>']               = { mode = 'n', opts = { noremap = true } },
    ['gc|<cmd>Lspsaga code_action<cr>']          = { mode = 'n', opts = { noremap = true } },
    ['gc|<cmd>Lspsaga range_code_action<cr>']    = { mode = 'n', opts = { noremap = true } },
    ['gd|<cmd>Lspsaga preview_definition<cr>']   = { mode = 'n', opts = { noremap = true } },
    ...
    -- barbar
    ['b,|<cmd>BufferPrevious<cr>']               = { mode = 'n', opts = { noremap = true } },
    ['b.|<cmd>BufferNext<cr>']                   = { mode = 'n', opts = { noremap = true } },
    ['bp|<cmd>BufferPin<cr>']                    = { mode = 'n', opts = { noremap = true } },
    ['bc|<cmd>BufferClose<cr>']                  = { mode = 'n', opts = { noremap = true } },
